...
function themeConfig($form)
{
    ...
    $articles = new Typecho_Widget_Helper_Form_Element_Text('articles', NULL, '/index.php/articles.html', _t('Articles URL'), _t('首页全部文章按钮指向的链接，需要创建Articles的自定义页面，并在此填入自定义页面的URL才可正常使用，不填则不显示，<strong><font color="#525288">强烈推荐开启</font></strong>，因为首页不支持文章翻页，一次仅能浏览有限数量文章。'));
    ...
    $cjCDNlink = new Typecho_Widget_Helper_Form_Element_Textarea(
        ...
        null,
        _t('公共静态资源自建地址'),
        _t('只在上面的选项选择自建时需要，<a href="https://tina.fmcf.cc/Docs/optimization/public_cdn/" target="_blank">[查看填写规则]</a>')
        );
