    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
        ...
        <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" class="comment-form" role="form">
            ...
            <div class="comment-form-grid">
                <div class="comment-form-field areatype-1">
                ...
                <div class="comment-form-field areatype-2">
            ...
            <div class="comment-form-textarea">
                <label for="comment" class="required"><?php _e('内容'); ?></label>
            ...
            <div class="comment-form-footer">
                ...
                <div class="comment-form-verification">
                    <?php spam_protection_math(); ?>
                </div>
                <?php endif; ?>
                <div class="comment-form-actions">
                    <button type="reset" class="submit submit-reset"><?php _e('清空内容'); ?></button>
                    <button type="submit" class="submit submit-send"><?php _e('提交评论'); ?></button>
                </div>
            </div>
